...
def brown_edge_detection(image_path):
    ...
    # Create a masks for the brown,green,yellow color
    ...
    # Calculate the percentage of healthy and unhealthy pixels
   ...
   # Create an image with the original color where green pixels are detected
    green_color_image = original_image.copy()
    green_color_image[green_mask != 0] = [0, 255, 0]  # Set green pixels to green for visualization

    # Create an image with the original color where yellow pixels are detected
